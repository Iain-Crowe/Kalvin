...
const Home = () => {
    ...
    return (
        <>
            {medScreen ? (
                <>
                    <div className="flex-row justify-between p-4 gap-4 font-display min-h-min">
                        <div className={`flex-row border-2 border-gray-600 dark:border-gray-500 bg-white dark:bg-secondary-dark h-56 w-full rounded-lg drop-shadow-xl overflow-y-auto ${smallScreen ? 'mt-16' : ''}`}>
                        ...
                        <div className="flex  mt-4 border-2 border-gray-600 dark:border-gray-500 bg-white dark:bg-secondary-dark h-[500px] w-full rounded-lg drop-shadow-xl overflow-y-auto">
                            Profile
                        </div>
                    </div>
                </>
